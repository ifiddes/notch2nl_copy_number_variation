...
def parse_args(args):
    ...
    parser.add_argument("--breakpoint_penalty", type=float, help="Breakpoint penalty (how easily do we want to open a gene conversion breakpoint?)", default=3.5)
    parser.add_argument("--data_penalty", type=float, help="data penalty (how accurate are the data?)", default=7)
    parser.add_argument("--end_penalty", type=float, help="end penalty (how often do we expect a full deletion?)", default=1.5)
